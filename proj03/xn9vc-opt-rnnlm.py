...
class RNN(nn.Module):
    ...
    ###### this is inspired by the coding example on PyTorch documentation
    def init_hidden(self):  # The axes semantics are (num_layers, minibatch_size, hidden_dim)
...
epoch = 1
# optimizer = optim.SGD(rnn.parameters(), lr=0.2, momentum=0.9)
optimizer = optim.Adagrad(rnn.parameters(), lr=0.2)
